  ...
  $.jalios.Browser = {
    ...
    popupWindow: function(url, title, w, h, status, resizable, scrollbars, reuse, winOpener, callback){
      ...
      try {
        ...
        if (!pWnd){ alert(I18N.glp('warn.popup.blocker')); }
      }
      catch(ex){
