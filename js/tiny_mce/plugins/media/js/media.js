(function() {
	...
	window.Media = {
		...
		preview : function() {
		  var previewHTML = this.editor.plugins.media.dataToHtml(this.data, true);
		  previewHTML = previewHTML.replace(/\$\{?baseUrl\}?/g, this.editor.documentBaseURI.getURI()); // JALIOS - JCMS-3920
			get('prev').innerHTML = previewHTML;
		},
