...
mejs.HtmlMediaElementShim = {
    ...
    if (options.customError) {
      ...
      errorContainer.innerHTML = (poster !== '') ?
        ...
        '<a href="' + playback.url + '"><span>' + mejs.i18n.t('mejs.download-file') + '</span></a>';
    }
...
/*
 * This is the default english i18n.locale language object.
 *
 * @see
 *   me-i18n.js
 *
...
;(function(exports, undefined) {
    ...
    if (typeof exports.en === 'undefined') {
        exports.en = {
            ...
            'mejs.progress-help-text': 'Use Left/Right Arrow keys to advance one second, Up/Down arrows to advance ten seconds.',
            'mejs.skip-back': 'Skip back %1 seconds', // %1 is replaced with skipBackInterval in this string
...
;(function(exports, undefined) {
    ...
    if (typeof exports.fr === 'undefined') {
        exports.fr = {
			...
			'mejs.fullscreen-off': "Désactiver le son",
			'mejs.mute': "Activer le son",
			'mejs.mute-toggle': "Activer/désactiver le son",
			'mejs.unmute': "Désactiver le son",
			'mejs.time-slider': "Curseur temporel",
			'mejs.progress-help-text': "Utilisez les flèches Gauche/Droite du clavier pour avancer d'une seconde, les flèches Haut/Bas pour avancer de 10 secondes.",
			'mejs.skip-back': "Reculer de %1 secondes",
...
(function($) {
	...
	$.extend(mejs.MepDefaults, {
		progessHelpText: mejs.i18n.t('mejs.progress-help-text')
	});
