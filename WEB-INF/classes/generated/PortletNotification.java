                ...
                com.jalios.jstore.Searchable
{
  ...
  public static IntegerFormReport getMaxResultsReport(SortedSet set) {
    ...
    for(Iterator it = set.iterator(); it.hasNext();) {
      PortletNotification obj = (PortletNotification)it.next();
      if (obj == null) {
        continue;
      }
  ...
  protected Publication prepareMergeCopy() {
    PortletNotification copy = (PortletNotification)super.prepareMergeCopy();
    PortletNotification main = (PortletNotification)mainInstance;
    return copy;
  }
}
// **********4A616C696F73204A434D53 *** SIGNATURE BOUNDARY ***
// z/iMy46FLSqnq7pBkIjQlA==
