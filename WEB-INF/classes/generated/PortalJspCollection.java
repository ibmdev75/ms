...
public  class PortalJspCollection extends generated.PortletJspCollection 
             implements 
               ...
               , com.jalios.jstore.Searchable
{
  ...
  public PortalJspCollection(AbstractCollection other) {
    super(other);
  }
  public PortalJspCollection(PortletJspCollection other) {
    super(other);
  }
  ...
  public static EnumerateFormReport getExactCategoryReport(SortedSet set) {
    ...
    for(Iterator it = set.iterator(); it.hasNext();) {
      PortalJspCollection obj = (PortalJspCollection)it.next();
      if (obj == null) {
        continue;
      }
  ...
  protected Publication prepareMergeCopy() {
    PortalJspCollection copy = (PortalJspCollection)super.prepareMergeCopy();
    PortalJspCollection main = (PortalJspCollection)mainInstance;
    JcmsUtil.mergeMLMap(copy.getDescriptionML(), main.getDescriptionML());
    return copy;
  }
}
// **********4A616C696F73204A434D53 *** SIGNATURE BOUNDARY ***
// v9x+fYYjlkL6CCfQ961Q7Q==
