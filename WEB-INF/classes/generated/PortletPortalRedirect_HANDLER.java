...
public class PortletPortalRedirect_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    value = (String)attributes.get("status");
    if (value != null) {
    ...
    value = (String)attributes.get("contentDBID");
    if (value != null) {
    ...
    value = (String)attributes.get("redirectForm");
    if (value != null) {
    ...
    value = (String)attributes.get("redirectPortlet");
    if (value != null) {
    ...
    value = (String)attributes.get("category");
    if (value != null) {
    ...
    value = (String)attributes.get("dispPortal");
    if (value != null) {
    ...
    value = (String)attributes.get("exactCategory");
    if (value != null) {
