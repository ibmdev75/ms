...
public class PortletColumn_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    value = (String)attributes.get("alignVertical");
    if (value != null) {
    ...
    value = (String)attributes.get("backgroundColor");
    if (value != null) {
    ...
    value = (String)attributes.get("backgroundImage");
    if (value != null) {
    ...
    value = (String)attributes.get("backgroundRepeat");
    if (value != null) {
