...
// Generation date : Wed Jan 28 18:43:37 CET 2015
                ...
                com.jalios.jstore.Searchable
{
  ...
  public static String[] cacheTypeValues = channel.getTypeFieldEntry(AbstractPortlet.class, "cacheType", true).getEnumerateValues();  
  public static String[] cacheTypeLabels = channel.getTypeFieldEntry(AbstractPortlet.class, "cacheType", true).getEnumerateLabels();
  public static HashMap<String, String[]> cacheTypeLabelMap = channel.getTypeFieldEntry(AbstractPortlet.class, "cacheType", true).getEnumerateLabelsMap();
  ...
  public static EnumerateFormReport getCacheTypeReport(SortedSet set) {
    ...
    for(Iterator it = set.iterator(); it.hasNext();) {
      AbstractPortlet obj = (AbstractPortlet)it.next();
      if (obj == null) {
        continue;
      }
  ...
  public static String[] cacheSensibilityValues = channel.getTypeFieldEntry(AbstractPortlet.class, "cacheSensibility", true).getEnumerateValues();  
  public static String[] cacheSensibilityLabels = channel.getTypeFieldEntry(AbstractPortlet.class, "cacheSensibility", true).getEnumerateLabels();
  public static HashMap<String, String[]> cacheSensibilityLabelMap = channel.getTypeFieldEntry(AbstractPortlet.class, "cacheSensibility", true).getEnumerateLabelsMap();
  ...
  public static String[] invalidClassValues = channel.getTypeFieldEntry(AbstractPortlet.class, "invalidClass", true).getEnumerateValues();  
  public static String[] invalidClassLabels = channel.getTypeFieldEntry(AbstractPortlet.class, "invalidClass", true).getEnumerateLabels();
  public static HashMap<String, String[]> invalidClassLabelMap = channel.getTypeFieldEntry(AbstractPortlet.class, "invalidClass", true).getEnumerateLabelsMap();
  ...
  public static String[] displayCSSValues = channel.getTypeFieldEntry(AbstractPortlet.class, "displayCSS", true).getEnumerateValues();  
  public static String[] displayCSSLabels = channel.getTypeFieldEntry(AbstractPortlet.class, "displayCSS", true).getEnumerateLabels();
  public static HashMap<String, String[]> displayCSSLabelMap = channel.getTypeFieldEntry(AbstractPortlet.class, "displayCSS", true).getEnumerateLabelsMap();
  ...
  public static String[] alignHValues = channel.getTypeFieldEntry(AbstractPortlet.class, "alignH", true).getEnumerateValues();  
  public static String[] alignHLabels = channel.getTypeFieldEntry(AbstractPortlet.class, "alignH", true).getEnumerateLabels();
  public static HashMap<String, String[]> alignHLabelMap = channel.getTypeFieldEntry(AbstractPortlet.class, "alignH", true).getEnumerateLabelsMap();
  ...
  public static String[] alignVValues = channel.getTypeFieldEntry(AbstractPortlet.class, "alignV", true).getEnumerateValues();  
  public static String[] alignVLabels = channel.getTypeFieldEntry(AbstractPortlet.class, "alignV", true).getEnumerateLabels();
  public static HashMap<String, String[]> alignVLabelMap = channel.getTypeFieldEntry(AbstractPortlet.class, "alignV", true).getEnumerateLabelsMap();
  ...
  public static String[] alignTableValues = channel.getTypeFieldEntry(AbstractPortlet.class, "alignTable", true).getEnumerateValues();  
  public static String[] alignTableLabels = channel.getTypeFieldEntry(AbstractPortlet.class, "alignTable", true).getEnumerateLabels();
  public static HashMap<String, String[]> alignTableLabelMap = channel.getTypeFieldEntry(AbstractPortlet.class, "alignTable", true).getEnumerateLabelsMap();
  ...
  public static String[] behaviorCopyValues = channel.getTypeFieldEntry(AbstractPortlet.class, "behaviorCopy", true).getEnumerateValues();  
  public static String[] behaviorCopyLabels = channel.getTypeFieldEntry(AbstractPortlet.class, "behaviorCopy", true).getEnumerateLabels();
  public static HashMap<String, String[]> behaviorCopyLabelMap = channel.getTypeFieldEntry(AbstractPortlet.class, "behaviorCopy", true).getEnumerateLabelsMap();
  ...
  public static String[] conditionValues = channel.getTypeFieldEntry(AbstractPortlet.class, "condition", true).getEnumerateValues();  
  public static String[] conditionLabels = channel.getTypeFieldEntry(AbstractPortlet.class, "condition", true).getEnumerateLabels();
  public static HashMap<String, String[]> conditionLabelMap = channel.getTypeFieldEntry(AbstractPortlet.class, "condition", true).getEnumerateLabelsMap();
  ...
  protected Publication prepareMergeCopy() {
    AbstractPortlet copy = (AbstractPortlet)super.prepareMergeCopy();
    AbstractPortlet main = (AbstractPortlet)mainInstance;
