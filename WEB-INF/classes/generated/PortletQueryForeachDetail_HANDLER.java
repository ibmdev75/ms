...
public class PortletQueryForeachDetail_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    value = (String)attributes.get("refineQueries");
    if (value != null) {
    ...
    value = (String)attributes.get("refineWithContextualCategories");
    if (value != null) {
        handler.setRefineWithContextualCategories(Boolean.valueOf(value).booleanValue());
    }

    value = (String)attributes.get("orderBy");
    if (value != null) {
    ...
    value = (String)attributes.get("reverseOrder");
    if (value != null) {
    ...
    value = (String)attributes.get("pagerLabel");
    if (value != null) {
    ...
    value = (String)attributes.get("pagerLabelML");
    if (value != null) {
    ...
    value = (String)attributes.get("firstPublicationsDBID");
    if (value != null) {
    ...
    value = (String)attributes.get("showInCurrentPortal");
    if (value != null) {
        handler.setShowInCurrentPortal(Boolean.valueOf(value).booleanValue());
    }

    value = (String)attributes.get("contextCategory");
    if (value != null) {
