...
public class Tag_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    value = (String)attributes.get("couleurFond");
    if (value != null) {
      handler.setCouleurFond((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "couleurFond")));
    }

    value = (String)attributes.get("couleurTexte");
    if (value != null) {
      handler.setCouleurTexte((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "couleurTexte")));
    }

    value = (String)attributes.get("compteur");
    if (value != null) {
        try {handler.setCompteur((Integer.valueOf(value)).intValue());} catch(NumberFormatException ex) {}
    }

    value = (String)attributes.get("url");
    if (value != null) {
      handler.setUrl((com.jalios.jcms.portlet.PortalElement)StoreUtil.decodeObject(com.jalios.jcms.portlet.PortalElement.class, value, store, new DecodeContext(sle, "url")));
    }
  ...
  public Map getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.Tag handler = (generated.Tag)storable;
    ...
    attributes.put("couleurFond", StoreUtil.encodeObject(handler.getCouleurFond(), store));
    attributes.put("couleurTexte", StoreUtil.encodeObject(handler.getCouleurTexte(), store));
    attributes.put("compteur", String.valueOf(handler.getCompteur()));
