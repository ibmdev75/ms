...
public class PortletLoggedMembers_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    value = (String)attributes.get("limitPortletAccess");
    if (value != null) {
        handler.setLimitPortletAccess(Boolean.valueOf(value).booleanValue());
    }

    value = (String)attributes.get("displayNumbers");
    if (value != null) {
        handler.setDisplayNumbers(Boolean.valueOf(value).booleanValue());
    }

    value = (String)attributes.get("displayMembers");
    if (value != null) {
    ...
    value = (String)attributes.get("displayLinkToMembersProfile");
    if (value != null) {
        handler.setDisplayLinkToMembersProfile(Boolean.valueOf(value).booleanValue());
    }

    value = (String)attributes.get("maximumMembers");
    if (value != null) {
