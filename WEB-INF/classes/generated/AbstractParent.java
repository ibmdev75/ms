                ...
                com.jalios.jstore.Searchable
{
  ...
  public static String[] cacheTypeValues = channel.getTypeFieldEntry(AbstractParent.class, "cacheType", true).getEnumerateValues();  
  public static String[] cacheTypeLabels = channel.getTypeFieldEntry(AbstractParent.class, "cacheType", true).getEnumerateLabels();
  public static HashMap<String, String[]> cacheTypeLabelMap = channel.getTypeFieldEntry(AbstractParent.class, "cacheType", true).getEnumerateLabelsMap();
  ...
  public static EnumerateFormReport getCacheTypeReport(SortedSet set) {
    ...
    for(Iterator it = set.iterator(); it.hasNext();) {
      AbstractParent obj = (AbstractParent)it.next();
      if (obj == null) {
        continue;
      }
  ...
  public static String[] cacheSensibilityValues = channel.getTypeFieldEntry(AbstractParent.class, "cacheSensibility", true).getEnumerateValues();  
  public static String[] cacheSensibilityLabels = channel.getTypeFieldEntry(AbstractParent.class, "cacheSensibility", true).getEnumerateLabels();
  public static HashMap<String, String[]> cacheSensibilityLabelMap = channel.getTypeFieldEntry(AbstractParent.class, "cacheSensibility", true).getEnumerateLabelsMap();
  ...
  public static String[] invalidClassValues = channel.getTypeFieldEntry(AbstractParent.class, "invalidClass", true).getEnumerateValues();  
  public static String[] invalidClassLabels = channel.getTypeFieldEntry(AbstractParent.class, "invalidClass", true).getEnumerateLabels();
  public static HashMap<String, String[]> invalidClassLabelMap = channel.getTypeFieldEntry(AbstractParent.class, "invalidClass", true).getEnumerateLabelsMap();
  ...
  public static String[] displayCSSValues = channel.getTypeFieldEntry(AbstractParent.class, "displayCSS", true).getEnumerateValues();  
  public static String[] displayCSSLabels = channel.getTypeFieldEntry(AbstractParent.class, "displayCSS", true).getEnumerateLabels();
  public static HashMap<String, String[]> displayCSSLabelMap = channel.getTypeFieldEntry(AbstractParent.class, "displayCSS", true).getEnumerateLabelsMap();
  ...
  public static String[] alignHValues = channel.getTypeFieldEntry(AbstractParent.class, "alignH", true).getEnumerateValues();  
  public static String[] alignHLabels = channel.getTypeFieldEntry(AbstractParent.class, "alignH", true).getEnumerateLabels();
  public static HashMap<String, String[]> alignHLabelMap = channel.getTypeFieldEntry(AbstractParent.class, "alignH", true).getEnumerateLabelsMap();
  ...
  public static String[] alignVValues = channel.getTypeFieldEntry(AbstractParent.class, "alignV", true).getEnumerateValues();  
  public static String[] alignVLabels = channel.getTypeFieldEntry(AbstractParent.class, "alignV", true).getEnumerateLabels();
  public static HashMap<String, String[]> alignVLabelMap = channel.getTypeFieldEntry(AbstractParent.class, "alignV", true).getEnumerateLabelsMap();
  ...
  public static String[] alignTableValues = channel.getTypeFieldEntry(AbstractParent.class, "alignTable", true).getEnumerateValues();  
  public static String[] alignTableLabels = channel.getTypeFieldEntry(AbstractParent.class, "alignTable", true).getEnumerateLabels();
  public static HashMap<String, String[]> alignTableLabelMap = channel.getTypeFieldEntry(AbstractParent.class, "alignTable", true).getEnumerateLabelsMap();
  ...
  public static String[] skinCSSValues = channel.getTypeFieldEntry(AbstractParent.class, "skinCSS", true).getEnumerateValues();  
  public static String[] skinCSSLabels = channel.getTypeFieldEntry(AbstractParent.class, "skinCSS", true).getEnumerateLabels();
  public static HashMap<String, String[]> skinCSSLabelMap = channel.getTypeFieldEntry(AbstractParent.class, "skinCSS", true).getEnumerateLabelsMap();
  ...
  public static String[] popupStateValues = channel.getTypeFieldEntry(AbstractParent.class, "popupState", true).getEnumerateValues();  
  public static String[] popupStateLabels = channel.getTypeFieldEntry(AbstractParent.class, "popupState", true).getEnumerateLabels();
  public static HashMap<String, String[]> popupStateLabelMap = channel.getTypeFieldEntry(AbstractParent.class, "popupState", true).getEnumerateLabelsMap();
  ...
  public static String[] expandStateValues = channel.getTypeFieldEntry(AbstractParent.class, "expandState", true).getEnumerateValues();  
  public static String[] expandStateLabels = channel.getTypeFieldEntry(AbstractParent.class, "expandState", true).getEnumerateLabels();
  public static HashMap<String, String[]> expandStateLabelMap = channel.getTypeFieldEntry(AbstractParent.class, "expandState", true).getEnumerateLabelsMap();
  ...
  public static String[] behaviorCopyValues = channel.getTypeFieldEntry(AbstractParent.class, "behaviorCopy", true).getEnumerateValues();  
  public static String[] behaviorCopyLabels = channel.getTypeFieldEntry(AbstractParent.class, "behaviorCopy", true).getEnumerateLabels();
  public static HashMap<String, String[]> behaviorCopyLabelMap = channel.getTypeFieldEntry(AbstractParent.class, "behaviorCopy", true).getEnumerateLabelsMap();
  ...
  public static String[] conditionValues = channel.getTypeFieldEntry(AbstractParent.class, "condition", true).getEnumerateValues();  
  public static String[] conditionLabels = channel.getTypeFieldEntry(AbstractParent.class, "condition", true).getEnumerateLabels();
  public static HashMap<String, String[]> conditionLabelMap = channel.getTypeFieldEntry(AbstractParent.class, "condition", true).getEnumerateLabelsMap();
  ...
  protected Publication prepareMergeCopy() {
    AbstractParent copy = (AbstractParent)super.prepareMergeCopy();
    AbstractParent main = (AbstractParent)mainInstance;
