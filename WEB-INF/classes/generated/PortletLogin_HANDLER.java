...
public class PortletLogin_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    value = (String)attributes.get("introduction");
    if (value != null) {
    ...
    value = (String)attributes.get("introductionML");
    if (value != null) {
    ...
    value = (String)attributes.get("loginText");
    if (value != null) {
    ...
    value = (String)attributes.get("loginTextML");
    if (value != null) {
    ...
    value = (String)attributes.get("passwordText");
    if (value != null) {
    ...
    value = (String)attributes.get("passwordTextML");
    if (value != null) {
    ...
    value = (String)attributes.get("buttonText");
    if (value != null) {
    ...
    value = (String)attributes.get("buttonTextML");
    if (value != null) {
