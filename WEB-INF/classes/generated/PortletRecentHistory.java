...
// Generation date : Wed Jan 28 18:44:00 CET 2015
                ...
                com.jalios.jstore.Searchable
{
  ...
  public static IntegerFormReport getHistorySizeReport(SortedSet set) {
    long sum = 0;
    int min = Integer.MAX_VALUE;
    int max = Integer.MIN_VALUE;
    for(Iterator it = set.iterator(); it.hasNext();) {
      PortletRecentHistory obj = (PortletRecentHistory)it.next();
      if (obj == null) {
        continue;
      }
  ...
  public static IntegerFormReport getPageSizeReport(SortedSet set) {
    long sum = 0;
    int min = Integer.MAX_VALUE;
    int max = Integer.MIN_VALUE;
    for(Iterator it = set.iterator(); it.hasNext();) {
  ...
  public static EnumerateFormReport getFilterOnCurrentWorkspaceReport(SortedSet set) {
    long sum = 0;
  ...
  protected Publication prepareMergeCopy() {
    PortletRecentHistory copy = (PortletRecentHistory)super.prepareMergeCopy();
    PortletRecentHistory main = (PortletRecentHistory)mainInstance;
    return copy;
  }
}
// **********4A616C696F73204A434D53 *** SIGNATURE BOUNDARY ***
// GtWwB7cdEPDQwe15q7spBg==
