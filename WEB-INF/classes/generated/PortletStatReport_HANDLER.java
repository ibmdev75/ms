...
public class PortletStatReport_HANDLER implements com.jalios.jstore.StorableHandler {

  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletStatReport handler = (generated.PortletStatReport)storable;
    String value;
    Map attributes = sle.getAttributes();
    value = (String)attributes.get("scheduleDate");
    if (value != null) {
      handler.setScheduleDate((java.util.Date)StoreUtil.decodeObject(java.util.Date.class, value, store, new DecodeContext(sle, "scheduleDate")));
    }

    value = (String)attributes.get("startingDate");
    if (value != null) {
      handler.setStartingDate((java.util.Date)StoreUtil.decodeObject(java.util.Date.class, value, store, new DecodeContext(sle, "startingDate")));
    }

    value = (String)attributes.get("endingDate");
    if (value != null) {
      handler.setEndingDate((java.util.Date)StoreUtil.decodeObject(java.util.Date.class, value, store, new DecodeContext(sle, "endingDate")));
    }

    value = (String)attributes.get("schedule");
    if (value != null) {
        try {handler.setSchedule((Long.valueOf(value)).longValue());} catch(NumberFormatException ex) {}
    }

    value = (String)attributes.get("children");
    if (value != null) {
    ...
    value = (String)attributes.get("childrenBindings");
    if (value != null) {
  ...
  public Map getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletStatReport handler = (generated.PortletStatReport)storable;
    Map attributes = new HashMap();
    attributes.put("scheduleDate", StoreUtil.encodeObject(handler.getScheduleDate(), store));
    attributes.put("startingDate", StoreUtil.encodeObject(handler.getStartingDate(), store));
    attributes.put("endingDate", StoreUtil.encodeObject(handler.getEndingDate(), store));
    attributes.put("schedule", String.valueOf(handler.getSchedule()));
