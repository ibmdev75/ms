...
public  class PortletWorkflow extends generated.PortletQueryForeach 
             implements 
                com.jalios.jstore.Searchable
{
  ...
  public PortletWorkflow(PortletQueryForeach other) {
    super(other);
  }
  ...
  public static IntegerFormReport getMaximumItemsPerWorkspaceReport(SortedSet set) {
    long sum = 0;
    int min = Integer.MAX_VALUE;
    int max = Integer.MIN_VALUE;
    for(Iterator it = set.iterator(); it.hasNext();) {
      PortletWorkflow obj = (PortletWorkflow)it.next();
      if (obj == null) {
        continue;
      }
  ...
  protected Publication prepareMergeCopy() {
    PortletWorkflow copy = (PortletWorkflow)super.prepareMergeCopy();
    PortletWorkflow main = (PortletWorkflow)mainInstance;
    return copy;
  }
}
// **********4A616C696F73204A434D53 *** SIGNATURE BOUNDARY ***
// 7/pWXX0gsX6obQDlShW9Fw==
