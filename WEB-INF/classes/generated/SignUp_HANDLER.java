...
public class SignUp_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    value = (String)attributes.get("firstName");
    if (value != null) {
    ...
    value = (String)attributes.get("jobTitle");
    if (value != null) {
    ...
    value = (String)attributes.get("favoriteLogin");
    if (value != null) {
    ...
    value = (String)attributes.get("message");
    if (value != null) {
    ...
    value = (String)attributes.get("submitMember");
    if (value != null) {
    ...
    value = (String)attributes.get("submitRemoteAddr");
    if (value != null) {
