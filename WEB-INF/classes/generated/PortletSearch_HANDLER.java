...
public class PortletSearch_HANDLER implements com.jalios.jstore.StorableHandler {
  ...
  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ...
    value = (String)attributes.get("searchWith");
    if (value != null) {
    ...
    value = (String)attributes.get("searchIn");
    if (value != null) {
    ...
    value = (String)attributes.get("instantSearch");
    if (value != null) {
        handler.setInstantSearch(Boolean.valueOf(value).booleanValue());
    }

    value = (String)attributes.get("query");
    if (value != null) {
    ...
    value = (String)attributes.get("queryPortlet");
    if (value != null) {
    ...
    value = (String)attributes.get("displayPortal");
    if (value != null) {
    ...
    value = (String)attributes.get("advancedSearchPortlet");
    if (value != null) {
