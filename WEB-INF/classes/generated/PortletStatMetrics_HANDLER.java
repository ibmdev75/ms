...
public class PortletStatMetrics_HANDLER implements com.jalios.jstore.StorableHandler {

  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    PortletStatMetrics handler = (generated.PortletStatMetrics)storable;
    String value;
    Map attributes = sle.getAttributes();
    value = (String)attributes.get("statListener");
    if (value != null) {
      handler.setStatListener((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "statListener")));
    }

    value = (String)attributes.get("tabGroup");
    if (value != null) {
      handler.setTabGroup((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "tabGroup")));
    }

    value = (String)attributes.get("tabGroupML");
    if (value != null) {
      handler.setTabGroupML((java.util.HashMap)StoreUtil.decodeObject(java.util.HashMap.class, value, store, new DecodeContext(sle, "tabGroupML")));
    }

    value = (String)attributes.get("displayTimeChart");
    if (value != null) {
        handler.setDisplayTimeChart(Boolean.valueOf(value).booleanValue());
    }

    value = (String)attributes.get("displayWeekChart");
    if (value != null) {
        handler.setDisplayWeekChart(Boolean.valueOf(value).booleanValue());
    }

    value = (String)attributes.get("displayAverage");
    if (value != null) {
        handler.setDisplayAverage(Boolean.valueOf(value).booleanValue());
    }

    value = (String)attributes.get("regExpFilter");
    if (value != null) {
        handler.setRegExpFilter(Boolean.valueOf(value).booleanValue());
    }

    value = (String)attributes.get("topTen");
    if (value != null) {
        try {handler.setTopTen((Integer.valueOf(value)).intValue());} catch(NumberFormatException ex) {}
    }

    value = (String)attributes.get("filteredArea");
    if (value != null) {
      handler.setFilteredArea((java.lang.String)StoreUtil.decodeObject(java.lang.String.class, value, store, new DecodeContext(sle, "filteredArea")));
    }
  ...
  public Map getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.PortletStatMetrics handler = (generated.PortletStatMetrics)storable;
    Map attributes = new HashMap();
    attributes.put("statListener", StoreUtil.encodeObject(handler.getStatListener(), store));
    attributes.put("tabGroup", StoreUtil.encodeObject(handler.getTabGroup(), store));
    attributes.put("tabGroupML", StoreUtil.encodeObject(handler.getTabGroupML(), store));
    attributes.put("displayTimeChart", String.valueOf(handler.getDisplayTimeChart()));
    attributes.put("displayWeekChart", String.valueOf(handler.getDisplayWeekChart()));
    attributes.put("displayAverage", String.valueOf(handler.getDisplayAverage()));
    attributes.put("regExpFilter", String.valueOf(handler.getRegExpFilter()));
    attributes.put("topTen", String.valueOf(handler.getTopTen()));
    attributes.put("filteredArea", StoreUtil.encodeObject(handler.getFilteredArea(), store));
