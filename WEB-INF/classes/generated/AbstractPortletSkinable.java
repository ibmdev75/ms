                ...
                com.jalios.jstore.Searchable
{
  ...
  public void exportXmlField(StringBuffer sb, int indentLevel) {
    ...
    sb.append(ExportUtil.exportField(indentLevel, "displayTitle", getDisplayTitle(), "displayTitleML", false, false));
    sb.append(ExportUtil.exportField(indentLevel, "displayTitleML", getDisplayTitleML(), false));
  ...
  protected HashMap descriptionML = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "description", true).getDefaultTextMap();
  ...
  protected HashMap portletImageML = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "portletImage", true).getDefaultTextMap();
  ...
  public static String[] cacheTypeValues = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "cacheType", true).getEnumerateValues();  
  public static String[] cacheTypeLabels = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "cacheType", true).getEnumerateLabels();
  public static HashMap<String, String[]> cacheTypeLabelMap = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "cacheType", true).getEnumerateLabelsMap();
  ...
  public static EnumerateFormReport getCacheTypeReport(SortedSet set) {
    ...
    for(Iterator it = set.iterator(); it.hasNext();) {
      AbstractPortletSkinable obj = (AbstractPortletSkinable)it.next();
      if (obj == null) {
        continue;
      }
  ...
  public static String[] cacheSensibilityValues = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "cacheSensibility", true).getEnumerateValues();  
  public static String[] cacheSensibilityLabels = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "cacheSensibility", true).getEnumerateLabels();
  public static HashMap<String, String[]> cacheSensibilityLabelMap = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "cacheSensibility", true).getEnumerateLabelsMap();
  ...
  public static String[] invalidClassValues = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "invalidClass", true).getEnumerateValues();  
  public static String[] invalidClassLabels = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "invalidClass", true).getEnumerateLabels();
  public static HashMap<String, String[]> invalidClassLabelMap = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "invalidClass", true).getEnumerateLabelsMap();
  ...
  public static String[] displayCSSValues = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "displayCSS", true).getEnumerateValues();  
  public static String[] displayCSSLabels = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "displayCSS", true).getEnumerateLabels();
  public static HashMap<String, String[]> displayCSSLabelMap = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "displayCSS", true).getEnumerateLabelsMap();
  ...
  public static String[] alignHValues = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "alignH", true).getEnumerateValues();  
  public static String[] alignHLabels = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "alignH", true).getEnumerateLabels();
  public static HashMap<String, String[]> alignHLabelMap = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "alignH", true).getEnumerateLabelsMap();
  ...
  public static String[] alignVValues = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "alignV", true).getEnumerateValues();  
  public static String[] alignVLabels = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "alignV", true).getEnumerateLabels();
  public static HashMap<String, String[]> alignVLabelMap = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "alignV", true).getEnumerateLabelsMap();
  ...
  public static String[] alignTableValues = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "alignTable", true).getEnumerateValues();  
  public static String[] alignTableLabels = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "alignTable", true).getEnumerateLabels();
  public static HashMap<String, String[]> alignTableLabelMap = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "alignTable", true).getEnumerateLabelsMap();
  ...
  protected HashMap displayTitleML = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "displayTitle", true).getDefaultTextMap();
  ...
  public HashMap getDisplayTitleML() { return displayTitleML; }
  public void setDisplayTitleML(HashMap v) { displayTitleML = v; }
  /**
   * Convenient method to set the value of the DisplayTitle field
   * in any language (default site language or any other).<br>
   * This method will set the proper field value
   * ({@link #setDisplayTitle(String)} or {@link #setDisplayTitleML(HashMap)})
   * depending on the specified language.
   * 
   * @param lang the language (ISO 639 code) in which to set the value
   * @param value the value to set.
  ...
  public void setDisplayTitle(String lang, String value) {
    ...
    if (displayTitleML == null) {
      ...
      displayTitleML = new HashMap<String,String>(displayTitleML);
    }
  ...
  public static String[] skinCSSValues = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "skinCSS", true).getEnumerateValues();  
  public static String[] skinCSSLabels = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "skinCSS", true).getEnumerateLabels();
  public static HashMap<String, String[]> skinCSSLabelMap = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "skinCSS", true).getEnumerateLabelsMap();
  ...
  public static String getSkinCSSLabel(String value, String userLang) {
    ...
    return ((String[])skinCSSLabelMap.get(channel.getLanguage()))[i];
  }
  ...
  public static EnumerateFormReport getSkinCSSReport(SortedSet set) {
    long sum = 0;
    ObjectIntTreeMap map = new ObjectIntTreeMap();
    for(Iterator it = set.iterator(); it.hasNext();) {
      AbstractPortletSkinable obj = (AbstractPortletSkinable)it.next();
  ...
  public static String[] popupStateValues = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "popupState", true).getEnumerateValues();  
  public static String[] popupStateLabels = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "popupState", true).getEnumerateLabels();
  public static HashMap<String, String[]> popupStateLabelMap = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "popupState", true).getEnumerateLabelsMap();
  ...
  public static String getPopupStateLabel(String value, String userLang) {
    ...
    return ((String[])popupStateLabelMap.get(channel.getLanguage()))[i];
  }
  ...
  public static EnumerateFormReport getPopupStateReport(SortedSet set) {
    long sum = 0;
    ObjectIntTreeMap map = new ObjectIntTreeMap();
    for(Iterator it = set.iterator(); it.hasNext();) {
      AbstractPortletSkinable obj = (AbstractPortletSkinable)it.next();
  ...
  public static String[] expandStateValues = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "expandState", true).getEnumerateValues();  
  public static String[] expandStateLabels = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "expandState", true).getEnumerateLabels();
  public static HashMap<String, String[]> expandStateLabelMap = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "expandState", true).getEnumerateLabelsMap();
  ...
  public static String getExpandStateLabel(String value, String userLang) {
    ...
    return ((String[])expandStateLabelMap.get(channel.getLanguage()))[i];
  }
  ...
  public static EnumerateFormReport getExpandStateReport(SortedSet set) {
    long sum = 0;
    ObjectIntTreeMap map = new ObjectIntTreeMap();
    for(Iterator it = set.iterator(); it.hasNext();) {
      AbstractPortletSkinable obj = (AbstractPortletSkinable)it.next();
  ...
  public static String[] behaviorCopyValues = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "behaviorCopy", true).getEnumerateValues();  
  public static String[] behaviorCopyLabels = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "behaviorCopy", true).getEnumerateLabels();
  public static HashMap<String, String[]> behaviorCopyLabelMap = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "behaviorCopy", true).getEnumerateLabelsMap();
  ...
  public static String[] conditionValues = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "condition", true).getEnumerateValues();  
  public static String[] conditionLabels = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "condition", true).getEnumerateLabels();
  public static HashMap<String, String[]> conditionLabelMap = channel.getTypeFieldEntry(AbstractPortletSkinable.class, "condition", true).getEnumerateLabelsMap();
  ...
  public String[] getSearchStrings() {
    ...
    if (displayTitleML != null) {
      for(Iterator it = displayTitleML.values().iterator(); it.hasNext();) {
        Object obj = it.next();
        if (obj != null) {
          sb.append(obj); sb.append(' ');
        }
  ...
  public ControllerStatus checkHtmlDisplayTitle() {
    ControllerStatus status = JcmsUtil.checkHtml(displayTitle, channel.getTypeFieldLabel(this, "displayTitle"));
    if (status.hasFailed()) {
      return status;
    }
    status = JcmsUtil.checkHtml(displayTitleML, channel.getTypeFieldLabel(this, "displayTitle"));
    if (status.hasFailed()) {
      return status;
    }
  ...
  protected Publication prepareMergeCopy() {
    AbstractPortletSkinable copy = (AbstractPortletSkinable)super.prepareMergeCopy();
    AbstractPortletSkinable main = (AbstractPortletSkinable)mainInstance;
    ...
    JcmsUtil.mergeMLMap(copy.getDisplayTitleML(), main.getDisplayTitleML());
    return copy;
  }
}
// **********4A616C696F73204A434D53 *** SIGNATURE BOUNDARY ***
// dHRL/JOdhX5MQL5V0cWbEw==
