               ...
               , com.jalios.jstore.Searchable
{
  ...
  public static EnumerateFormReport getShowDisplayHeaderFooterReport(SortedSet set) {
    long sum = 0;
    ObjectIntTreeMap map = new ObjectIntTreeMap();
    for(Iterator it = set.iterator(); it.hasNext();) {
      PortletSelection obj = (PortletSelection)it.next();
      if (obj == null) {
        continue;
      }
  ...
  protected Publication prepareMergeCopy() {
    PortletSelection copy = (PortletSelection)super.prepareMergeCopy();
    PortletSelection main = (PortletSelection)mainInstance;
    return copy;
  }
}
// **********4A616C696F73204A434D53 *** SIGNATURE BOUNDARY ***
// 8cJX9+uZ7WvdiNMFO7o9qA==
