...
// Generation date: Fri Apr 03 22:18:35 CEST 2015
...
public class ArticleMS_HANDLER implements com.jalios.jstore.StorableHandler {

  public void setAttributes(com.jalios.jstore.Storable storable, StorableLogEntry sle, com.jalios.jstore.Store store) {
    ArticleMS handler = (generated.ArticleMS)storable;
    String value;
    Map attributes = sle.getAttributes();
    value = (String)attributes.get("tag");
    if (value != null) {
      handler.setTag((generated.Tag[])StoreUtil.decodeObject(generated.Tag[].class, value, store, new DecodeContext(sle, "tag")));
    }
    ...
    value = (String)attributes.get("picture");
    if (value != null) {
    ...
    value = (String)attributes.get("pictureML");
    if (value != null) {
    ...
    value = (String)attributes.get("content");
    if (value != null) {
    ...
    value = (String)attributes.get("contentML");
    if (value != null) {
    ...
    value = (String)attributes.get("relatedContents");
    if (value != null) {
    ...
    value = (String)attributes.get("relatedContentsDBID");
    if (value != null) {
  ...
  public Map getAttributes(com.jalios.jstore.Storable storable, com.jalios.jstore.Store store) {
    generated.ArticleMS handler = (generated.ArticleMS)storable;
    Map attributes = new HashMap();
    attributes.put("tag", StoreUtil.encodeObject(handler.getTag(), store));
