...
<article>
    <div class="container-overview">
            ...
            <div class="description">Add convenient function to Function prototype</div>
...
<dl class="details">
	...
	<dd class="tag-source"><ul class="dummy"><li>jalios-common.js, line 91</li></ul></dd>
...
<dt>
    <h4 class="name" id="defer"><span class="type-signature"></span>defer</h4>
...
<dl class="details">
	...
	<dt class="tag-source">Source:</dt>
	<dd class="tag-source"><ul class="dummy"><li>jalios-common.js, line 106</li></ul></dd>
    ...
    <pre class="prettyprint">  var func = function(arg1, arg2){ ... }
  func.defer(arg1, arg2);</pre>
...
<dt>
    <h4 class="name" id="delay"><span class="type-signature"></span>delay</h4>
...
<table class="params table table-bordered table-striped">
	...
	<tbody>
        ...
        <tr>
            ...
            <td class="description last">the delay in seconds</td>
        </tr>
...
<dl class="details">
	...
	<dt class="tag-source">Source:</dt>
	<dd class="tag-source"><ul class="dummy"><li>jalios-common.js, line 123</li></ul></dd>
...
<dt>
    <h4 class="name" id="postpone"><span class="type-signature"></span>postpone</h4>
...
<dl class="details">
	...
	<dt class="tag-source">Source:</dt>
	<dd class="tag-source"><ul class="dummy"><li>jalios-common.js, line 142</li></ul></dd>
