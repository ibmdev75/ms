...
<code>$('#id A:nth-child(2)').tab('show');</code></div>
...
<dl class="details">
	...
	<dd class="tag-source"><ul class="dummy"><li>jalios-tab.js, line 176</li></ul></dd>
  ...
  <li><a href="js/tests/jalios/core/jalios-tab.html" target="_blank">js/tests/jalios/core/jalios-tab.html</a></li>
...
<dt>
    <h4 class="name" id="select"><span class="type-signature">&lt;static> </span>select<span class="type-signature"></span></h4>
...
<dl class="details">
	...
	<dt class="tag-source">Source:</dt>
	<dd class="tag-source"><ul class="dummy"><li>jalios-tab.js, line 209</li></ul></dd>
...
<dt>
    <h4 class="name" id="upgrade"><span class="type-signature">&lt;static> </span>upgrade<span class="type-signature"></span></h4>
...
<dl class="details">
	...
	<dt class="tag-source">Source:</dt>
	<dd class="tag-source"><ul class="dummy"><li>jalios-tab.js, line 204</li></ul></dd>
