...
<div class="fullDisplay PortletLoggedMembers <%= obj.canBeEditedFieldByField(loggedMember) ? "unitFieldEdition" : "" %>">
...
<table class="fields">
  ...
  <tr class="field displayMembers enumerateEditor abstract <%= Util.isEmpty(obj.getDisplayMembers()) ? "empty" : "" %>">
    ...
    <td class='field-data' <%= gfla(obj, "displayMembers") %>>
            <jalios:if predicate='<%= Util.notEmpty(obj.getDisplayMembers()) %>'>
