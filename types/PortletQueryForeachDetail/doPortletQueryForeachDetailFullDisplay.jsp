...
<div class="fullDisplay PortletQueryForeachDetail <%= obj.canBeEditedFieldByField(loggedMember) ? "unitFieldEdition" : "" %>">
...
<table class="fields">
  ...
  <tr class="field showDate enumerateEditor  <%= Util.isEmpty(obj.getShowDate()) ? "empty" : "" %>">
    ...
    <td class='field-data' <%= gfla(obj, "showDate") %>>
            <jalios:if predicate='<%= Util.notEmpty(obj.getShowDate()) %>'>
