...
%><%--
  @Summary: AbstractPortletStatReport editor
  @Category: Generated
...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditAbstractPortletStatReportHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/AbstractPortletStatReport/editAbstractPortletStatReportModal.jsp">
<div class="row AbstractPortletStatReport">
	<%-- Title ------------------------------------------------------------ --%>
	...
	<% } %>
	<jalios:include jsp="types/AbstractPortletStatReport/doEditAbstractPortletStatReportModal.jsp" />
</div>
</jalios:modal>
<% 
