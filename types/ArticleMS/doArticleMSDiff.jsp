...
<%--
  @Summary: generated.ArticleMS diff page
  @Category: Generated
...
<% 
{ 
generated.ArticleMS newObj = (generated.ArticleMS)request.getAttribute("newPub"); 
generated.ArticleMS oldObj = (generated.ArticleMS)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.ArticleMS.class);
...
%>
<jsp:include page="/types/Article/doArticleDiff.jsp"/>
<%
  {
    Integer superFieldCount = (Integer)request.getAttribute("fieldCount");
    if (superFieldCount != null) {
...
%>
  <%-- ** tag ***************** --%>
  <jalios:if predicate='<%= !Util.isSameContent(newObj.getTag(), oldObj.getTag()) %>'>
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap"><%= channel.getTypeFieldLabel(generated.ArticleMS.class, "tag", userLang) %></td>
    <td>
      <% if (Util.notEmpty(newObj.getTag())) { %>
      <ol>
        <jalios:foreach name="itData" type="Data" array="<%= newObj.getTag() %>">
        <li>
        <% if (itData != null) { %> 
    ...
    <td>
      <% if (Util.notEmpty(oldObj.getTag())) { %>
      <ol>
        <jalios:foreach name="itData" type="Data" array="<%= oldObj.getTag() %>">
        <li>
        <% if (itData != null) { %> 
        <%   if (itData instanceof FileDocument) { %>
        <a href="work/displayWork.jsp?id=<%= itData.getId() %>&amp;details=true"><jalios:fileicon doc='<%= ((FileDocument)itData) %>' /></a>
