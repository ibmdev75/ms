...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditArticleMSHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/ArticleMS/editArticleMSModal.jsp">
<div class="row ArticleMS">
	<%-- Title ------------------------------------------------------------ --%>
	...
	<% } %>
	<jalios:include jsp="types/ArticleMS/doEditArticleMSModal.jsp" />
</div>
</jalios:modal>
<% 
