...
<div class="fullDisplay PortletJspCollection <%= obj.canBeEditedFieldByField(loggedMember) ? "unitFieldEdition" : "" %>">
...
<table class="fields">
  <tr class="field jsp textfieldEditor  <%= Util.isEmpty(obj.getJsp()) ? "empty" : "" %>">
    ...
    <td class='field-data' <%= gfla(obj, "jsp") %>>
            <jalios:if predicate='<%= Util.notEmpty(obj.getJsp()) %>'>
            <%= obj.getJsp() %>
            </jalios:if>
    </td>
  </tr>
