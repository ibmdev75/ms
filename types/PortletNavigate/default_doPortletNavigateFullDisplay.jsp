...
<div class="fullDisplay PortletNavigate <%= obj.canBeEditedFieldByField(loggedMember) ? "unitFieldEdition" : "" %>">
...
<table class="fields">
  ...
  <tr class="field refineCategory enumerateEditor  <%= Util.isEmpty(obj.getRefineCategory()) ? "empty" : "" %>">
    ...
    <td class='field-data' <%= gfla(obj, "refineCategory") %>>
            <jalios:if predicate='<%= Util.notEmpty(obj.getRefineCategory()) %>'>
