...
<%--
  @Summary: generated.PortletStatMetrics diff page
  @Category: Generated
...
<% 
{ 
generated.PortletStatMetrics newObj = (generated.PortletStatMetrics)request.getAttribute("newPub"); 
generated.PortletStatMetrics oldObj = (generated.PortletStatMetrics)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletStatMetrics.class);
...
<% } %>
  ...
  <%-- ** statListener ***************** --%>
  <jalios:if predicate='<%= !Util.isSameContent(newObj.getStatListener(), oldObj.getStatListener()) %>'>
  <tr class="vTop">
    <td class="text-right"><%= fieldCount++ %>.</td>
    <td nowrap="nowrap">
      <%= channel.getTypeFieldLabel(generated.PortletStatMetrics.class, "statListener", userLang) %>
    </td>
    <td><%= Util.getString(newObj.getStatListener(), "") %></td>
    <td><%= Util.getString(oldObj.getStatListener(), "") %></td>
  </tr>
  </jalios:if>
<%
...
%>
<jsp:include page="/types/AbstractPortletStat/doAbstractPortletStatDiff.jsp"/>
<%
  {
    Integer superFieldCount = (Integer)request.getAttribute("fieldCount");
    if (superFieldCount != null) {
