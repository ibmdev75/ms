...
%><%--
  @Summary: PortletStatMetrics display page
  @Category: Generated
...
%><% PortletStatMetrics obj = (PortletStatMetrics)portlet; %><%
%><%@ include file='/front/doFullDisplay.jspf' %>
<div class="fullDisplay PortletStatMetrics <%= obj.canBeEditedFieldByField(loggedMember) ? "unitFieldEdition" : "" %>">
<%@ include file='/front/publication/doPublicationHeader.jspf' %>
<table class="fields">
  <tr class="field statListener enumerateEditor  <%= Util.isEmpty(obj.getStatListener()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "statListener", userLang) %></td>
    <td class='field-data' <%= gfla(obj, "statListener") %>>
            <jalios:if predicate='<%= Util.notEmpty(obj.getStatListener()) %>'>
            <%= obj.getStatListenerLabel(obj.getStatListener(), userLang) %>
            </jalios:if>
    </td>
  </tr>
  <tr class="field tabGroup textfieldEditor  <%= Util.isEmpty(obj.getTabGroup(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "tabGroup", userLang) %></td>
  ...
  <tr class="field displayTimeChart booleanEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "displayTimeChart", userLang) %></td>
    <td class='field-data' >
            <%= obj.getDisplayTimeChartLabel(userLang) %>
    </td>
  </tr>
  <tr class="field displayWeekChart booleanEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "displayWeekChart", userLang) %></td>
    <td class='field-data' >
            <%= obj.getDisplayWeekChartLabel(userLang) %>
    </td>
  </tr>
  <tr class="field displayAverage booleanEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "displayAverage", userLang) %></td>
    <td class='field-data' >
            <%= obj.getDisplayAverageLabel(userLang) %>
    </td>
  </tr>
  <tr class="field regExpFilter booleanEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "regExpFilter", userLang) %></td>
    <td class='field-data' >
            <%= obj.getRegExpFilterLabel(userLang) %>
    </td>
  </tr>
  <tr class="field topTen intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "topTen", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field filteredArea enumerateEditor  <%= Util.isEmpty(obj.getFilteredArea()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "filteredArea", userLang) %></td>
  ...
  <tr class="field description textareaEditor abstract <%= Util.isEmpty(obj.getDescription(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "description", userLang) %></td>
  ...
  <tr class="field portletImage imageEditor  <%= Util.isEmpty(obj.getPortletImage(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "portletImage", userLang) %></td>
  ...
  <tr class="field cacheType enumerateEditor  <%= Util.isEmpty(obj.getCacheType()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "cacheType", userLang) %></td>
  ...
  <tr class="field cacheSensibility enumerateEditor  <%= Util.isEmpty(obj.getCacheSensibility()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "cacheSensibility", userLang) %></td>
  ...
  <tr class="field invalidClass enumerateEditor  <%= Util.isEmpty(obj.getInvalidClass()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "invalidClass", userLang) %></td>
  ...
  <tr class="field invalidTime durationEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "invalidTime", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field displayCSS enumerateEditor  <%= Util.isEmpty(obj.getDisplayCSS()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "displayCSS", userLang) %></td>
  ...
  <tr class="field width textfieldEditor  <%= Util.isEmpty(obj.getWidth()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "width", userLang) %></td>
  ...
  <tr class="field insetLeft intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "insetLeft", userLang) %></td>
    <td class='field-data' >
            <% /* %>123456789<% */ %><%= NumberFormat.getInstance(userLocale).format(obj.getInsetLeft()) %>&nbsp;px
    </td>
  </tr>
  <tr class="field insetRight intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "insetRight", userLang) %></td>
    <td class='field-data' >
            <% /* %>123456789<% */ %><%= NumberFormat.getInstance(userLocale).format(obj.getInsetRight()) %>&nbsp;px
    </td>
  </tr>
  <tr class="field insetTop intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "insetTop", userLang) %></td>
    <td class='field-data' >
            <% /* %>123456789<% */ %><%= NumberFormat.getInstance(userLocale).format(obj.getInsetTop()) %>&nbsp;px
    </td>
  </tr>
  <tr class="field insetBottom intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "insetBottom", userLang) %></td>
    <td class='field-data' >
            <% /* %>123456789<% */ %><%= NumberFormat.getInstance(userLocale).format(obj.getInsetBottom()) %>&nbsp;px
    </td>
  </tr>
  <tr class="field cellPadding intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "cellPadding", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field alignH enumerateEditor  <%= Util.isEmpty(obj.getAlignH()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "alignH", userLang) %></td>
  ...
  <tr class="field alignV enumerateEditor  <%= Util.isEmpty(obj.getAlignV()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "alignV", userLang) %></td>
  ...
  <tr class="field alignTable enumerateEditor  <%= Util.isEmpty(obj.getAlignTable()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "alignTable", userLang) %></td>
  ...
  <tr class="field border intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "border", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field borderColor colorEditor  <%= Util.isEmpty(obj.getBorderColor()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "borderColor", userLang) %></td>
  ...
  <tr class="field backColor colorEditor  <%= Util.isEmpty(obj.getBackColor()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "backColor", userLang) %></td>
  ...
  <tr class="field backImage imageEditor  <%= Util.isEmpty(obj.getBackImage()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "backImage", userLang) %></td>
  ...
  <tr class="field displayTitle textfieldEditor  <%= Util.isEmpty(obj.getDisplayTitle(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "displayTitle", userLang) %></td>
  ...
  <tr class="field skins textfieldEditor  <%= Util.isEmpty(obj.getSkins()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "skins", userLang) %></td>
  ...
  <tr class="field skinCSS enumerateEditor  <%= Util.isEmpty(obj.getSkinCSS()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "skinCSS", userLang) %></td>
  ...
  <tr class="field popupState enumerateEditor  <%= Util.isEmpty(obj.getPopupState()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "popupState", userLang) %></td>
  ...
  <tr class="field expandState enumerateEditor  <%= Util.isEmpty(obj.getExpandState()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "expandState", userLang) %></td>
  ...
  <tr class="field behaviorCopy enumerateEditor  <%= Util.isEmpty(obj.getBehaviorCopy()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "behaviorCopy", userLang) %></td>
  ...
  <tr class="field originalPortlet linkEditor  <%= Util.isEmpty(obj.getOriginalPortlet()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "originalPortlet", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field condition enumerateEditor  <%= Util.isEmpty(obj.getCondition()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "condition", userLang) %></td>
  ...
  <tr class="field cssId textfieldEditor  <%= Util.isEmpty(obj.getCssId()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "cssId", userLang) %></td>
  ...
  <tr class="field cssClasses textfieldEditor  <%= Util.isEmpty(obj.getCssClasses()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "cssClasses", userLang) %></td>
  ...
  <tr class="field skinClasses textfieldEditor  <%= Util.isEmpty(obj.getSkinClasses()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatMetrics.class, "skinClasses", userLang) %></td>
