...
%><%--
  @Summary: PortletStatMetrics editor
  @Category: Generated
...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditPortletStatMetricsHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletStatMetrics/editPortletStatMetricsModal.jsp">
<div class="row PortletStatMetrics">
	<%-- Title ------------------------------------------------------------ --%>
	...
	<% } %>
	<jalios:include jsp="types/PortletStatMetrics/doEditPortletStatMetricsModal.jsp" />
</div>
</jalios:modal>
<% 
