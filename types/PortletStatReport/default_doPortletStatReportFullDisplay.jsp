...
%><%--
  @Summary: PortletStatReport display page
  @Category: Generated
...
%><% PortletStatReport obj = (PortletStatReport)portlet; %><%
%><%@ include file='/front/doFullDisplay.jspf' %>
<div class="fullDisplay PortletStatReport <%= obj.canBeEditedFieldByField(loggedMember) ? "unitFieldEdition" : "" %>">
<%@ include file='/front/publication/doPublicationHeader.jspf' %>
<table class="fields">
  <tr class="field scheduleDate dateEditor  <%= Util.isEmpty(obj.getScheduleDate()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "scheduleDate", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field startingDate dateEditor  <%= Util.isEmpty(obj.getStartingDate()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "startingDate", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field endingDate dateEditor  <%= Util.isEmpty(obj.getEndingDate()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "endingDate", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field schedule durationEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "schedule", userLang) %></td>
    <td class='field-data' >
            <jalios:duration time='<%= obj.getSchedule() * 1000L %>'/>
    </td>
  </tr>
  <tr class="field children linkEditor  <%= Util.isEmpty(obj.getChildren()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "children", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field childrenBindings textfieldEditor  <%= Util.isEmpty(obj.getChildrenBindings()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "childrenBindings", userLang) %></td>
  ...
  <tr class="field description textareaEditor abstract <%= Util.isEmpty(obj.getDescription(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "description", userLang) %></td>
  ...
  <tr class="field portletImage imageEditor  <%= Util.isEmpty(obj.getPortletImage(userLang)) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "portletImage", userLang) %></td>
  ...
  <tr class="field cacheType enumerateEditor  <%= Util.isEmpty(obj.getCacheType()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "cacheType", userLang) %></td>
  ...
  <tr class="field cacheSensibility enumerateEditor  <%= Util.isEmpty(obj.getCacheSensibility()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "cacheSensibility", userLang) %></td>
  ...
  <tr class="field invalidClass enumerateEditor  <%= Util.isEmpty(obj.getInvalidClass()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "invalidClass", userLang) %></td>
  ...
  <tr class="field invalidTime durationEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "invalidTime", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field displayCSS enumerateEditor  <%= Util.isEmpty(obj.getDisplayCSS()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "displayCSS", userLang) %></td>
  ...
  <tr class="field width textfieldEditor  <%= Util.isEmpty(obj.getWidth()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "width", userLang) %></td>
  ...
  <tr class="field insetLeft intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "insetLeft", userLang) %></td>
    <td class='field-data' >
            <% /* %>123456789<% */ %><%= NumberFormat.getInstance(userLocale).format(obj.getInsetLeft()) %>&nbsp;px
    </td>
  </tr>
  <tr class="field insetRight intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "insetRight", userLang) %></td>
    <td class='field-data' >
            <% /* %>123456789<% */ %><%= NumberFormat.getInstance(userLocale).format(obj.getInsetRight()) %>&nbsp;px
    </td>
  </tr>
  <tr class="field insetTop intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "insetTop", userLang) %></td>
    <td class='field-data' >
            <% /* %>123456789<% */ %><%= NumberFormat.getInstance(userLocale).format(obj.getInsetTop()) %>&nbsp;px
    </td>
  </tr>
  <tr class="field insetBottom intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "insetBottom", userLang) %></td>
    <td class='field-data' >
            <% /* %>123456789<% */ %><%= NumberFormat.getInstance(userLocale).format(obj.getInsetBottom()) %>&nbsp;px
    </td>
  </tr>
  <tr class="field cellPadding intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "cellPadding", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field alignH enumerateEditor  <%= Util.isEmpty(obj.getAlignH()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "alignH", userLang) %></td>
  ...
  <tr class="field alignV enumerateEditor  <%= Util.isEmpty(obj.getAlignV()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "alignV", userLang) %></td>
  ...
  <tr class="field alignTable enumerateEditor  <%= Util.isEmpty(obj.getAlignTable()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "alignTable", userLang) %></td>
  ...
  <tr class="field border intEditor  ">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "border", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field borderColor colorEditor  <%= Util.isEmpty(obj.getBorderColor()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "borderColor", userLang) %></td>
  ...
  <tr class="field backColor colorEditor  <%= Util.isEmpty(obj.getBackColor()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "backColor", userLang) %></td>
  ...
  <tr class="field backImage imageEditor  <%= Util.isEmpty(obj.getBackImage()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "backImage", userLang) %></td>
  ...
  <tr class="field behaviorCopy enumerateEditor  <%= Util.isEmpty(obj.getBehaviorCopy()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "behaviorCopy", userLang) %></td>
  ...
  <tr class="field originalPortlet linkEditor  <%= Util.isEmpty(obj.getOriginalPortlet()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "originalPortlet", userLang) %></td>
    <td class='field-data' >
  ...
  <tr class="field condition enumerateEditor  <%= Util.isEmpty(obj.getCondition()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "condition", userLang) %></td>
  ...
  <tr class="field cssId textfieldEditor  <%= Util.isEmpty(obj.getCssId()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "cssId", userLang) %></td>
  ...
  <tr class="field cssClasses textfieldEditor  <%= Util.isEmpty(obj.getCssClasses()) ? "empty" : "" %>">
    <td class='field-label'><%= channel.getTypeFieldLabel(PortletStatReport.class, "cssClasses", userLang) %></td>
