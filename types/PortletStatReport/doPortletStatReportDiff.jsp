...
<%--
  @Summary: generated.PortletStatReport diff page
  @Category: Generated
...
<% 
{ 
generated.PortletStatReport newObj = (generated.PortletStatReport)request.getAttribute("newPub"); 
generated.PortletStatReport oldObj = (generated.PortletStatReport)request.getAttribute("oldPub"); 
String[] vids = (String[])request.getAttribute("vids"); 
int fieldCount = 1; 
TypeEntry typeEntry = channel.getTypeEntry(generated.PortletStatReport.class);
...
%>
<jsp:include page="/types/AbstractPortletStatReport/doAbstractPortletStatReportDiff.jsp"/>
<%
  {
    Integer superFieldCount = (Integer)request.getAttribute("fieldCount");
    if (superFieldCount != null) {
