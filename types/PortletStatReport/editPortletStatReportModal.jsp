...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/PortletStatReport/editPortletStatReportModal.jsp">
<div class="row PortletStatReport">
	...
	<% } %>
	<jalios:include jsp="types/PortletStatReport/doEditPortletStatReportModal.jsp" />
</div>
</jalios:modal>
<% 
