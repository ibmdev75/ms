...
%><%--
  @Summary: AbstractPortletStat editor
  @Category: Generated
...
%><jsp:useBean id='formHandler' scope='page' class='generated.EditAbstractPortletStatHandler'><%
...
%><% formHandler.prepare(); %>
<jalios:modal formHandler="<%= formHandler %>" url="types/AbstractPortletStat/editAbstractPortletStatModal.jsp">
<div class="row AbstractPortletStat">
	<%-- Title ------------------------------------------------------------ --%>
	...
	<% } %>
	<jalios:include jsp="types/AbstractPortletStat/doEditAbstractPortletStatModal.jsp" />
</div>
</jalios:modal>
<% 
