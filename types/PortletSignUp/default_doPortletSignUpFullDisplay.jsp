...
<div class="fullDisplay PortletSignUp <%= obj.canBeEditedFieldByField(loggedMember) ? "unitFieldEdition" : "" %>">
...
<table class="fields">
  ...
  <tr class="field label textfieldEditor  <%= Util.isEmpty(obj.getLabel(userLang)) ? "empty" : "" %>">
    ...
    <td class='field-data' <%= gfla(obj, "label") %>>
            <jalios:if predicate='<%= Util.notEmpty(obj.getLabel(userLang)) %>'>
